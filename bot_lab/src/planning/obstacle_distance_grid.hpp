...
/*
obstacle_distance_grid_test command line:
./bin/obstacle_distance_grid_test
_________________________________________________
botgui + obstacle_distance_grid_test command line

go to botlab folder:
./bin/slam --mapping-only

open new terminal, botlab forl der:
source setenv.sh
cd data
lcm-logplayer-gui obstacle_slam_10mx10m_5cm.log

open another terminal, run botgui:
source setenv.sh
./bin/botgui
*/
// #ifndef PLANNING_OBSTACLE_DISTANCE_GRID_HPP
...
//     /**
//      * @brief initialize the distances to cells (x, y) based on whether the cell is occupied or not
//      * 
//      */
//     void initializeDistances( const OccupancyGrid& map );
